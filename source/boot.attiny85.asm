;;; generated by ../../BootSetup/BootSetup.rb (2017-09-29 20:08:57 +0200)
...
;;; ========================================================================
	...
	rjmp  ISR_TIMER0          	; Timer0 Compare A
...
RESET:	ldi   r16, 0x00           	; 0
	...
	ldi   r17, 0x33           	; 51
	out   OCR0A, r17          	; Output Compare Register A [0x29]
	ldi   r17, 0x02           	; 2
	out   TCCR0A, r17         	; Timer/Counter Control Register A [0x2a]
	...
	out   TCCR0B, r17         	; Timer/Counter Control Register B [0x33]
	ldi   r17, 0x21           	; 33
	out   MCUCR, r17          	; MCU Control Register [0x35]
	out   TIFR, r16           	; Timer/Counter Interrupt Flag Register [0x38]
	ldi   r17, 0x10           	; 16
	out   TIMSK, r17          	; Timer/Counter Interrupt Mask Register [0x39]
	ldi   r17, 0x40           	; 64
